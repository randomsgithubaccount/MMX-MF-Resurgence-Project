...
if instance_exists(MegamanX) 
{
	...
	str[1] = "I PREPARED SOME INTERCHANGEABLE PARTS FOR YOU. THESE ARE THE GROUND ARMOR'S LEG PARTS."
	str[2] = "THEY’LL ALLOW YOU TO GO AT HIGH SPEED, CROSS HARD TERRAIN AND DEFEND YOURSELF FROM ENEMIES."
