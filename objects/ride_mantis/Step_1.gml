...
if bbox_bottom>parWater.bbox_top && inwater=0 {spl=instance_create_depth(x,y,depth,watersplash); instance_create_depth(x+16,y,depth,watersplash); instance_create_depth(x-16,y,depth,watersplash); sound_effect=SFX_waterspl; inwater=1}
if bbox_bottom<parWater.bbox_top && inwater=1 {spl=instance_create_depth(x,y,depth,watersplash); instance_create_depth(x+16,y,depth,watersplash); instance_create_depth(x-16,y,depth,watersplash); sound_effect=SFX_waterspl; inwater=0}
...
{
if place_meeting(x,y,parenemy) {damage=1; scr_damage_turtle(); global.canmove=0}
if place_meeting(x,y,enedmgparent) {damage=1; scr_damage_turtle(); global.canmove=0}
if place_meeting(x,y,bossdmgpar) {damage=2; scr_damage_turtle(); global.canmove=0}
if place_meeting(x,y,bossparent) {damage=2; scr_damage_turtle(); global.canmove=0}
}
