...
if global.char=0
{
if sprite_index=spr_mantis_run {charride=s_mmx_riderun}
if sprite_index=spr_mantis_jump {charride=s_mmx_ridestand}
}

if global.char=1
{
if sprite_index=spr_mantis_run {charride=s_z_riderun}
if sprite_index=spr_mantis_jump {charride=s_z_ridestand}
}

if global.char=2
{
if sprite_index=spr_mantis_run {charride=s_axl_riderun}
if sprite_index=spr_mantis_jump {charride=s_axl_ridestand}
}
