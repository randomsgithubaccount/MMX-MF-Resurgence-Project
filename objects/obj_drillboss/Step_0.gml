...
hit=y - (hj/2)
if sprite_index=spr_drilldroid {image_speed=0.1; hsp=0}
if sprite_index=spr_drilldroid_atk {image_speed=0.3}
if sprite_index=spr_drilldroid_jump {image_speed=0.4}
if sprite_index=spr_drilldroid_atk2 {image_speed=0.3; hsp=0}
...
if free=true && sprite_index=spr_drilldroid && vsp!=0 {sprite_index=spr_drilldroid_jump; image_index=4}

if free=true && sprite_index=spr_drilldroid_jump
{
    if vsp<=0 {image_index=min(image_index,3)}
    if vsp>0 {image_index=min(image_index,4)}
}

if sprite_index=spr_drilldroid_jump
{
    ...
    if image_index>=5 && jump=1 
    {
        ...
        instance_create_depth(x-sprite_width/3,y,depth,smokeobj); 
        instance_create_depth(__view_get( e__VW.XView, 0 )+176+random_range(-150,150),__view_get( e__VW.YView, 0 ),depth,intro_box)
        hsp=0; 
...
if sprite_index=spr_drilldroid_atk2
{
...
if sprite_index=spr_drilldroid_atk
{
...
sprite_index=spr_drilldroid_jump; image_index=0
}
}
