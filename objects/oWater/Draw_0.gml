...
draw_set_color(c_white);
 ...
 for (var xOff = -32; xOff <= __view_get( e__VW.XView, 0 ) + 352+ 32; xOff += 32)
 {
  draw_background_ext(sprw1, xOff+(xoffset*dir), y, 1, 1, 0, -1, image_alpha);      
  
  for (var yOff = 32; yOff <= __view_get( e__VW.YView, 0 ) - y + 240; yOff += 32)
  {
   draw_background_ext(sprw2, xOff+(xoffset*dir), y+yOff, 1, 1, 0, -1, image_alpha);
  } 
 }
draw_set_blend_mode(bm_normal);
