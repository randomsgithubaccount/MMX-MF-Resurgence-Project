...
if place_meeting(x,y-4,obj_machboss) {enehp=0}
if place_meeting(x-4,y,walldroid2_ene) {enehp=0}
if place_meeting(x+4,y,walldroid2_ene) {enehp=0}
if vsp>0 
...
instance_create_depth(bbox_left+(xcenter/2),bbox_bottom,smokeobj);
instance_create_depth(bbox_left-(xcenter/2),bbox_bottom,smokeobj); 
instance_create_depth(bbox_left+(xcenter/3),bbox_bottom,smokeobj);
instance_create_depth(bbox_left-(xcenter/3),bbox_bottom,smokeobj); 
snd=0
}
