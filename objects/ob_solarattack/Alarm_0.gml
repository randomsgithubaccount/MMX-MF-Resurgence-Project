...
{
	nearestene=instance_nearest(x,y,playerparent)
    if countdir=0
    {
        if nearestene.y-16<y {up=0; down=1; left=0; right=0} else if nearestene.y-16>y {up=1; down=0; left=0; right=0} else {up=0; down=0; left=0; right=0}
    }
    else if countdir=1
    {
