...
function script73() {
	...
	//var seconds_passed = delta_time/20000;
	//var move_speed_this_frame = (hsp+fric)*seconds_passed;
	x += (hsp+fric)
	...
	with(obj_railblock) {if place_meeting(x,y-2,other) && (!place_meeting(x+speedrail,y,other)) {other.fric=speedrail}}
