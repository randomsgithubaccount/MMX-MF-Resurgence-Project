function scrDrawHealth(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	/*
	...
	*/
	...
	dy = argument6;
	dTempA = drwVal;
	//Next we draw the pieces of the bar.
	...
	*/
	...
	draw_sprite(basSpr,global.mavskills,dx+12,dy);
